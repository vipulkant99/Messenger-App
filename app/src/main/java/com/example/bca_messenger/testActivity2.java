...
public class testActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dref = FirebaseDatabase.getInstance().getReference().child("BCA 2nd Year");
    ...
    private void showChats() {
        ...
        pd = new ProgressDialog(testActivity2.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==R.id.you) {
            if (user1 != null && auth != null) {
                auth.signOut();
                startActivity(new Intent(testActivity2.this, logIn.class));
                finish();
            }
        }
        else if (item.getItemId()==R.id.profile){
            startActivity(new Intent(testActivity2.this,sttngs.class));
        }
