...
public class testActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dref = FirebaseDatabase.getInstance().getReference().child("BCA 3rd Year");
    ...
    private void showChats() {
        ...
        pd = new ProgressDialog(testActivity3.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==R.id.you) {
            if (user1 != null && auth != null) {
                auth.signOut();
                startActivity(new Intent(testActivity3.this, logIn.class));
                finish();
            }
        }
        else if (item.getItemId()==R.id.profile){
            startActivity(new Intent(testActivity3.this,sttngs.class));
        }
